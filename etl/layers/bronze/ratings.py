...
class RatingsBronzeETL(TableETL):
    """
    RatingsBronzeETL is a class that handles the ETL (Extract, Transform, Load) process for the 'ratings' table in the bronze layer of the data lake.
    ...
    def extract_upstream(self) -> List[ETLDataSet]:
        ...
        This method retrieves ratings data from a specified table in the upstream source,
        ...
        Returns:
            ...
            extracted ratings data.
        """
        table_name = "rainforest.ratings"
        ratings_data = get_upstream_table(table_name, self.spark)
    ...
    def transform_upstream(
        ...
        """
        ratings_data = upstream_datasets[0].current_data
        current_timestamp = datetime.now()

        tranformed_data = ratings_data.withColumn(
