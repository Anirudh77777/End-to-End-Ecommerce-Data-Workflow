...
class OrderItemBronzeETL(TableETL):
    """
    OrderItemBronzeETL is a class that handles the ETL (Extract, Transform, Load) process for the 'order_item' table in the bronze layer of the data lake.
    ...
    def extract_upstream(self) -> List[ETLDataSet]:
        ...
        This method retrieves order_item data from a specified table in the upstream source,
