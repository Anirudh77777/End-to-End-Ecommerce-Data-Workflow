...
class ClickstreamBronzeETL(TableETL):
    """
    ClickstreamBronzeETL is a class that handles the ETL (Extract, Transform, Load) process for the 'clickstream' table in the bronze layer of the data lake.
    ...
    def extract_upstream(self) -> List[ETLDataSet]:
        ...
        This method retrieves clickstream data from a specified table in the upstream source,
    ...
    def transform_upstream(
        ...
        """
        clickstream_data = upstream_datasets[0].current_data
        current_timestamp = datetime.now()

        tranformed_data = clickstream_data.withColumn(
