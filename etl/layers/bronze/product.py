...
class ProductBronzeETL(TableETL):
    """
    ProductBronzeETL is a class that handles the ETL (Extract, Transform, Load) process for the 'product' table in the bronze layer of the data lake.
    ...
    def extract_upstream(self) -> List[ETLDataSet]:
        ...
        This method retrieves product data from a specified table in the upstream source,
    ...
    def transform_upstream(
        ...
        tranformed_data = product_data.withColumn(
