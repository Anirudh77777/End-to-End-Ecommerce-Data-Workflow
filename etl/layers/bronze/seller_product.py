...
class SellerProductBronzeETL(TableETL):
    """
    SellerProductBronzeETL is a class that handles the ETL (Extract, Transform, Load) process for the 'seller_product' table in the bronze layer of the data lake.
    ...
    Attributes:
        ...
        current_data (DataFrame): The curret DataFrame being processed.
    ...
    def extract_upstream(self) -> List[ETLDataSet]:
        ...
        This method retrieves seller_product data from a specified table in the upstream source,
        ...
        etl_dataset = ETLDataSet(
            name=self.name,
            current_data=seller_product_data,
