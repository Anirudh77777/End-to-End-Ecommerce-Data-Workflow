...
class CategoryBronzeETL(TableETL):
    """
    CategoryBronzeETL is a class that handles the ETL (Extract, Transform, Load) process for the 'category' table in the bronze layer of the data lake.
    ...
    def __init__(
        ...
        storage_path: str = "s3a://rainforest/delta/bronze/category",
    ...
    def extract_upstream(self) -> List[ETLDataSet]:
        ...
        This method retrieves category data from a specified table in the upstream source,
