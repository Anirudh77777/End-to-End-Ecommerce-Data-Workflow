...
class ProductCategoryBronzeETL(TableETL):
    """
    ProductCategoryBronzeETL is a class that handles the ETL (Extract, Transform, Load) process for the 'product_category' table in the bronze layer of the data lake.
    ...
    def extract_upstream(self) -> List[ETLDataSet]:
        ...
        This method retrieves product_category data from a specified table in the upstream source,
        ...
        Returns:
            ...
            extracted product_category data.
        """
        ...
        etl_dataset = ETLDataSet(
            name=self.name,
            current_data=product_category_data,
